...
where $H(P) = - \sum_{i,j} P_{i,j} \log P_{i,j} \propto -\text{KL}(P, a \otimes b)$. where KL is the Kullback–Leibler divergence and $a \otimes b$ the joint distribution of $a$ and $b$.
