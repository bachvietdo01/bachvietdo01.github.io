...
Here, $X_t \sim p_t(\cdot)$ traces the marginal probability path, $u_t(X_t)$ is the deterministic vector field, $\sigma_t^2$ is the diffusion coefficient, and $W_t$ denotes Brownian motion. Personally, I find the SDE perspective more intuitive and rigorous. Formally, the SDE $(1)$ describes the **underdamped Langevin diffusion process** (see [Cheng et al., 2018](https://arxiv.org/pdf/1707.03663))
