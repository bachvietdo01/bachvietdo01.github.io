...
The marignal flow generated by the "average" $u_t(x)$ is the probablity path that we desire! Okay, let's get into the implementation which is almost identical to what we saw in the earlier post.
